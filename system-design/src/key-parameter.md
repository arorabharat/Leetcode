...
1.How many total users are going be there ? 2.How many active users are going be there per month, per day ?
...
[![Alt text](https://img.youtube.com/vi/rUDN40rdly8/0.jpg)](https://www.youtube.com/watch?v=rUDN40rdly8)

## Distributed system

## Consistent hashing

[![Alt txt](../.././resources/wiki.png)](https://en.wikipedia.org/wiki/Consistent_hashing)

1. consistent hash is used in partition and scalable systems. it aimed to reduce partition data inter-transmission
